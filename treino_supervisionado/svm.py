...
def getDados(pasta):
    types = ('*.tif', '*jpg2')
    diretory = 'C:/Users/augus/Documents/ProjPIBIC/k-means/treino_supervisionado/'
    fill = ['0/', '1/', '2/', '3/', '4/']
    images = []
    y_true = []
    imagePaths = []
    ...
    return whitened, y_true, imagePaths


x_train, y_train, name_train = getDados("train")
sns.countplot(y_train)
plt.show()

x_test, y_test, name_test = getDados("test")
...
saida['image_name'] = name_test
saida['label'] = y_predict
...
classe = 'classe-'
diretory = 'C:/Users/augus/Documents/ProjPIBIC/k-means/treino_supervisionado/results/'
